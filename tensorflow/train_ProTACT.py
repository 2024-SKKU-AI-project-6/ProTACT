...
def main():
    ...
    # numpy data
    # rescale the scores from -1 to 1
    ...
    # shape; (num_samples, max_sentnum, max_sentlen)
    ...
    # model training
    # to gpu device
    train_features_list = [X_train_pos, X_train_prompt,
                           X_train_prompt_pos, X_train_linguistic_features, X_train_readability]
    dev_features_list = [X_dev_pos, X_dev_prompt, X_dev_prompt_pos,
                         X_dev_linguistic_features, X_dev_readability]
    test_features_list = [X_test_pos, X_test_prompt, X_test_prompt_pos,
                          X_test_linguistic_features, X_test_readability]
    ...
    for ii in range(epochs):
        ...
        print("Train Loss: ",
              custom_hist.train_loss[-1], "|| Val Loss: ", custom_hist.val_loss[-1])
